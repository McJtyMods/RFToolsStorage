...
public class NameItemSorter implements ItemSorter {
    ...
    public static int compareNames(Pair<ItemStack, Integer> o1, Pair<ItemStack, Integer> o2) {
        String name1 = o1.getLeft().getHoverName().getString() /* was getFormattedText() */.toLowerCase();
        String name2 = o2.getLeft().getHoverName().getString() /* was getFormattedText() */.toLowerCase();
