...
public class StorageRecipeTransferHandler implements IRecipeTransferHandler<ModularStorageContainer, CraftingRecipe> {
    ...
    @Nullable
    @Override
    public IRecipeTransferError transferRecipe(ModularStorageContainer container, CraftingRecipe recipe, IRecipeLayout recipeLayout, Player player, boolean maxTransfer, boolean doTransfer) {
