...
public class StorageScannerRecipeTransferHandler implements IRecipeTransferHandler<StorageScannerContainer, RecipeHolder<CraftingRecipe>> {
    ...
    @Nullable
    @Override
    public IRecipeTransferError transferRecipe(StorageScannerContainer container, RecipeHolder<CraftingRecipe> recipe, IRecipeSlotsView recipeLayout, Player player, boolean maxTransfer, boolean doTransfer) {
